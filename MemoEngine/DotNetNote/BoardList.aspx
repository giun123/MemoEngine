    ...
    <table style="width: 700px; margin-left: auto; margin-right: auto;">
        <tr>
            <td>
                ...
                <asp:GridView ID="ctlBoardList" runat="server" AutoGenerateColumns="false" DataKeyNames="Id" CssClass="table table-bordered table-hover table-condensec table-striped table-responsive">
                    <Columns>
                        <asp:TemplateField HeaderText="번호" HeadText="번호" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <%--<%# Eval("Id") %>--%>
